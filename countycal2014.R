...
infected_years_file = paste0(ffIn, "infections/gpkg/years/2014/inf_years_file_2014.gpkg")#"infections/rasters/2014/usa_2014_infections.tif")
number_of_observations = 294
prior_number_of_observations = 1814
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2014/inf_filelist_2014.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2014_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2014_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2014.tif")
precip = FALSE
