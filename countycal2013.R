...
infected_years_file = paste0(ffIn, "infections/gpkg/years/2013/inf_years_file_2013.gpkg")#"infections/rasters/2013/usa_2013_infections.tif")
number_of_observations = 347 
prior_number_of_observations = 1467
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2013/inf_filelist_2013.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2013_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2013_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2013.tif")
precip = FALSE
