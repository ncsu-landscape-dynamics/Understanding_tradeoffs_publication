...
infected_years_file = paste0(ffIn, "infections/gpkg/years/2016/inf_years_file_2016.gpkg")#"infections/rasters/2016/usa_2016_infections.tif")
number_of_observations = 39
prior_number_of_observations = 2264
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2016/inf_filelist_2016.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2016_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2016_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2016.tif")
precip = FALSE
