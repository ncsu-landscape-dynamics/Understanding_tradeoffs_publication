...
ffIn <- "/rs1/researchers/c/cmjone25/Late_blight/"
ffout <- "/rs1/researchers/c/cmjone25/Late_blight/modelresults/2010/"


# This has all the time steps for a calibration/validation duration
infected_years_file = paste0(ffIn, "infections/gpkg/years/2010/inf_years_file_2010.gpkg")#"infections/rasters/2009/usa_2009_infections.tif")
number_of_observations = 243
prior_number_of_observations = 639
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2010/inf_filelist_2010.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2010_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2010_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2010.tif")
precip = FALSE
