...
infected_years_file = paste0(ffIn, "infections/gpkg/years/2019/inf_years_file_2019.gpkg")#"infections/rasters/2009/usa_2009_infections.tif")
number_of_observations = 65
prior_number_of_observations = 2460
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2019/inf_filelist_2019.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2019_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2019_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2019.tif")
precip = FALSE
