...
infected_years_file = paste0(ffIn, "infections/gpkg/years/2020/inf_years_file_2020.gpkg")#"infections/rasters/2009/usa_2009_infections.tif")
number_of_observations = 17
prior_number_of_observations = 2525
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2020/inf_filelist_2020.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2020_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2020_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2020.tif")
precip = FALSE
