...
ffout <- "/rs1/researchers/c/cmjone25/Late_blight/modelresults/"

# This has all the time steps for a calibration/validation duration
infected_years_file = paste0(ffIn, "infections/gpkg/years/2011/inf_years_file_2011.gpkg")#"infections/rasters/2011/usa_2011_infections.tif")
number_of_observations = 1058
prior_number_of_observations = 882
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2011/inf_filelist_2011.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2011_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2011_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2011.tif")
precip = FALSE
