...
ffout <- "/rs1/researchers/c/cmjone25/Late_blight/modelresults/2009"


# These are ignored for pops_multirun?
#infected_years_file = paste0(ffIn, "infections/gpkg/years/2009/inf_years_file_2009.gpkg")#"infections/rasters/2009/usa_2009_infec
tions.tif")
...
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "temp/wx09_2_crop.tif")
precip = FALSE
