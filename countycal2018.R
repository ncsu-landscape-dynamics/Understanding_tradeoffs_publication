...
infected_years_file = paste0(ffIn, "infections/gpkg/years/2018/inf_years_file_2018.gpkg")#"infections/rasters/2018/usa_2018_infections.tif")
number_of_observations = 42
prior_number_of_observations = 2418
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2018/inf_filelist_2018.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2018_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2018_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2018.tif")
precip = FALSE
