...
infected_years_file = paste0(ffIn, "infections/gpkg/years/2015/inf_years_file_2015.gpkg")#"infections/rasters/2015/usa_2015_infections.tif")
number_of_observations = 156
prior_number_of_observations = 2108
...
infected_file_list = paste0(ffIn, "infections/gpkg/filelist/2015/inf_filelist_2015.gpkg")
host_file_list = paste0(ffIn, "hosts/host_2015_nona.tif")
total_populations_file = paste0(ffIn, "all_populations/tot_pop_2015_nona.tif")
temp = TRUE
temperature_coefficient_file = paste0(ffIn, "Weather_data/weather_us_2015.tif")
precip = FALSE
