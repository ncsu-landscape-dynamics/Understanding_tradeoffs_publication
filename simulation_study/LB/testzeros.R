...
infected_years_file <- file.path(rootdir, "inputs/infection/testzero.tif")
number_of_observations = 356
...
infected_file_list <- file.path(rootdir, "inputs/infection/infection_2021_rev_10locs.tif")
...
output_folder_path = file.path(rootdir, "outputs21/locs10x2/upwdrev/calib")
network_filename = ""
network_movement = "walk"
#success_metric = "quantity and rmse"  OLD PoPS
success_metric = "mcc"
