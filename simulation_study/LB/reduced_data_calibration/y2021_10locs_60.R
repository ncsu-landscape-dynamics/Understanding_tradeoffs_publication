...
infected_years_file <- file.path(rootdir, "outputs21/locs10x2/upwdrev/rasts/med_loc10_60.tif")
...
infected_file_list = file.path(rootdir, "outputs21/locs10x2/upwdrev/rasts/med_loc10_60.tif")
...
output_folder_path = file.path(rootdir, "outputs21/locs10x2/upwdrev/calib/60")
network_filename = c("")
...
saveRDS(calib_out, file.path(output_folder_path, "y21_10_60.RDS"))
