...
infected_years_file <- file.path(rootdir, "outputs21/locs10x2/upwdrev/rasts/med_loc10_75.tif")
number_of_observations <- 297
...
infected_file_list = file.path(rootdir, "outputs21/locs10x2/upwdrev/rasts/med_loc10_75.tif")
...
output_folder_path = file.path(rootdir, "outputs21/locs10x2/upwdrev/calib/75")
network_filename = c("")
