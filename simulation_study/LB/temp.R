...
infected_years_file <- file.path(rootdir, "outputs21/locs20x2/rasts/pops_median_Year_2021.tif")
number_of_observations <- 12
prior_number_of_observations <- 0
prior_means <- file.path(rootdir, "inputs/parameters/lb_means.csv")
...
infected_file_list = file.path(rootdir, "outputs21/locs20x2/rasts/pops_median_Year_2021.tif")
...
output_folder_path = file.path(rootdir, "outputs21/locs20x2/calib")
network_filenames = c("")
