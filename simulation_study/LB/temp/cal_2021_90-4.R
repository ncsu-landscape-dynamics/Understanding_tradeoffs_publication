...
infected_years_file <- file.path(rootdir, "rasts/infection/2021/r90/med_loc10_90-4.tif")
number_of_observations <- 324
...
infected_file_list = file.path(rootdir, "rasts/infection/2021/pops_median_Year_2021.tif")
...
output_folder_path = file.path("outputs/calib")
network_filename = c("")
...
saveRDS(calib_out, file.path(output_folder_path, "cal21_90-4.RDS"))
