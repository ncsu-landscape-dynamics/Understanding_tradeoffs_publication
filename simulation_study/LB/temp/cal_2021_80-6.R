...
infected_years_file <- file.path(rootdir, "rasts/infection/2021/r80/med_loc10_80-6.tif")
number_of_observations <- 301
...
saveRDS(calib_out, file.path(output_folder_path, "cal21_80-6.RDS"))
