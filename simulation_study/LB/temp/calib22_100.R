...
infected_file_list <- file.path(rootdir, "outputs22/locs10x2/upwdrev/rasts/mean2022redczero.tif")
host_file_list <- file.path(rootdir, "inputs/host/host_no_na_rv_2022.tif")
total_populations_file <- file.path(rootdir, "inputs/all_populations/tot_pop_no_na_rv_2022.tif")
temp = TRUE
temperature_coefficient_file = file.path(rootdir, "inputs/weather/wx_coef/lb_2022_coef_avg.tif")
precip = FALSE
...
exposed_file_list = ""
verbose = TRUE
write_outputs = "all_simulations"#"None"
output_folder_path = file.path(rootdir, "outputs22/locs10x2/upwdrev/calib")
network_filename = ""
network_movement = "walk"
success_metric = "quantity and rmse"
...
saveRDS(cal, file.path(output_folder_path, "cal202210100.RDS"))
