...
infected_years_file <- file.path(rootdir, "rasts/infection/2021/r90/med_loc10_90-6.tif")
number_of_observations <- 323
...
saveRDS(calib_out, file.path(output_folder_path, "cal21_90-6.RDS"))
