...
infected_years_file <- file.path(rootdir, "outputs21/locs10x2/upwdrev/rasts/pops_median_Year_2021.tif")
...
infected_file_list = file.path(rootdir, "outputs21/locs10x2/upwdrev/rasts/pops_median_Year_2021.tif")
...
output_folder_path = file.path(rootdir, "outputs21/calib/locs10up")
network_filename = c("")
...
saveRDS(calib_out, file.path(output_folder_path, "out.RDS"))
